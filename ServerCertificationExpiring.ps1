...
Import-Module "C:\Powershell\Modules\dev\dev.psd1" 
Import-Module WebAdministration

$FarmServers = $env:FarmServers -split ","  # We define the servers from the Azure variable (eg "Test1, Test2")
$stageName = $env:RELEASE_ENVIRONMENTNAME # we define the name of the stage from azure in order to enter the HTML as such
$daysBeforeExpiration = 30
$outputPath = "\\share\Dev\IstekCert$stageName.html"
$outputPathRmReporting = "\\share\Dev\Reporting\CertKojiIsticu_$stageName.html"
