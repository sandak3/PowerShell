...
If ($expiringSoon.Count -gt 0){
   ...
   #slanje mejla
   Send-MailMessage -From "noreplay@bancaintesa.rs" -To "sanda.kovacevic@bancaintesa.rs" -Subject "UPOZORENJE: SSL sertifikati uskoro isticu " -Body $body -SmtpServer "smtp.server.com" -UseSsl}
else{
