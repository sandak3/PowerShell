...
$driver.Navigate().GoToUrl("http://test1:8888/onCall")
...
$projekti = @{
    "Develope" = "Develope implementacija" 
    "Test2" = "Test2 implementacija i grеške"
    "Test" = "Test implementacija"
    "Test bagovi" = "Test grеške"
}
...
$driver.Navigate().GoToUrl("http://Test/WorkHours/calendar")
Start-Sleep -Seconds 10
